...
local function test_map_creation()
  local map = Map.new()
  Assert.is_true(map ~= nil)
end

local function test_map_set_get_size()
  local map = Map.new()
  local size = {y = 10, x = 7}
  map:set_size(size)
...
local function test_map_is_inboard()
  local map = Map.new()
  local size = {y = 10, x = 7}
  map:set_size(size)
...
local function test_map_clamp_pos()
  local size = {y = 10, x = 7}
  local p11 = {y = 0, x = 0}
  local p12 = {y = 1, x = 1}
  local p21 = {y = 100, x = 1}
...
local function test_map_get_random_pos()
  local size = {y = 10, x = 7}
  local map = Map.new()
  map:set_size(size)
  for i = 1, 99 do
...
local function test_map()
  test_map_creation()
  test_map_set_get_size()
  test_map_is_inboard()
  test_map_clamp_pos()
  test_map_get_random_pos()
  test_map_tile()
end
